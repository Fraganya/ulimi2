            ...
            @if(count($categories)==0)
                <div class="panel panel-default">
                    <div class="panel-body">
                        <i class="fa fa-info-circle"></i>&nbsp;There are no animal feed categories yet!
                    </div>
                </div>
            @else
            <table class="table table-striped">
                <caption>All Feed Categories (Paginated)</caption>
                <thead>
                <tr>
                    <td>ID</td>
                    <td>Name</td>
                ...
                @foreach($categories as $cat)
                    <tr>
                        ...
                        <td>{{$cat->language}}</td>
                        <td>
                            <a href="{{URL('feed-cats/remove',$cat->id)}}" class="btn btn-danger btn-sm" title="Delete">
